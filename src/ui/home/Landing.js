...
function Landing() {
    ...
    return (
        <Container>
            <img data-aos="fade-up" data-aos-duration="1500" className="profile-image" src={ProfileImage} alt="Me standing"/>
            <div className="container-text">
                <div className="container-name">
                    <p className="text-name">David Dekeuwer</p>
                </div>

                <h2 className="text-developer">Développeur <span>d'application</span></h2>
