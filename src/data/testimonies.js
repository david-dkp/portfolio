const testimonies = [
    {
        ...
        S'il est certain que ses acquis techniques sont importants, David a également su se démarquer lors de sa formation par sa capacité à retranscrire son travail au cours de chaque soutenance de projet auprès des différents évaluateurs de la formation.
        Je ne peux que recommander David pour la qualité des projets qu'il réalise.`,
        source: {
            name: "LinkedIn",
            linkUrl: "https://www.linkedin.com/in/david-dekeuwer-1940a01b9/",
        },
        name: "Denis",
        type: "Mentor",
    },
